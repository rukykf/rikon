                ...
                <div class="card-body">
                    ...
                    <div class="pt-3">
                        <div class="form-group ">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="optradio" :disabled="disabled" value="transfer" v-model="paymentMethod"
                                       class="ml-5">Transfer
                            </label>
                            <label class="radio-inline">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="amount" name="amount" :disabled="disabled" v-model.number="amount" placeholder="0.00" required
                                   class="form-control ">
                        </div>
                    ...
                    <p>
                        ...
                        <button class="btn btn-success" @click.stop.prevent="validateAndSubmit" v-else-if="state === 'add-another-payment'">
                        ...
                        <button v-else type="button" :disabled="disabled" @click.stop.prevent="validateAndSubmit" class="btn btn-primary px-4">
