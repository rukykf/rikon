                ...
                <div class="card-body">
                    ...
                    <div class="pt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="text" :disabled="disabled" v-model="name" placeholder=""
                                   required
                                   class="form-control ">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="roomNumber">
                                ...
                                <small v-if="roomNumberValidation !== null" class="text-danger">* {{
                                    roomNumberValidation }}</small>
                            </label>

                            <input type="number" id="roomNumber" name="number" :disabled="disabled"
                                   v-model.number="roomNumber" placeholder="e.g 103"
                                   class="form-control ">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="phoneNumber">
                                ...
                                <small v-if="phoneNumberValidation !== null" class="text-danger">* {{
                                    phoneNumberValidation }}</small>
                            </label>

                            <input type="text" id="phoneNumber" name="text" :disabled="disabled" v-model="phoneNumber"
                    ...
                    <p>
                        ...
                        <button v-else type="button" :disabled="disabled" @click.stop.prevent="validateAndSubmit"
