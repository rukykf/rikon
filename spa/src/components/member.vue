...
<template>
 <div>
  <div class="media mt-1 border-top pt-3">
   ...
   <b-dropdown variant="black" right toggle-class="arrow-none text-muted pr-0">
    <template v-slot:button-content>
     <i class="uil uil-ellipsis-v"></i>
    </template>
    <!-- item-->
    <b-dropdown-item href="javascript:void(0);"><i class="uil uil-edit-alt mr-2"></i>Edit</b-dropdown-item>
    <!-- item-->
    <b-dropdown-item href="javascript:void(0);"><i class="uil uil-exit mr-2"></i>Remove from Team </b-dropdown-item>
