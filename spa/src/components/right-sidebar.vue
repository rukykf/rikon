  ...
  export default {
    ...
    methods: {
      ...
      handleRightBarClick(e, el) {
        if (e.target && e.target.classList.contains("rightbar-overlay")) this.$parent.hideRightSidebar()
      },
      middleware(event, el) {
        ...
        <VuePerfectScrollbar style="height: 100%">
          ...
          <div class="px-3 py-1">
            ...
            <a href="javascript: void(0);" @click="changeLayout('horizontal')">
              <img src="@assets/images/layouts/horizontal.jpg" alt="horizontal" class="img-thumbnail demo-img" />
            </a>
          </div>
          <div class="px-3 py-1">
            <h6>Dark Side Nav</h6>
          ...
          <div class="px-3 py-1">
            ...
            <a href="javascript: void(0);" @click="changeWidth('boxed')">
              <img src="@assets/images/layouts/boxed.jpg" alt="boxed" class="img-thumbnail demo-img" />
            </a>
          </div>
        </VuePerfectScrollbar>
      </div>
