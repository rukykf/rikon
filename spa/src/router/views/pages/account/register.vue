          ...
          <form action="#" class="authentication-form">
           <div class="form-group">
            ...
            <div class="input-group input-group-merge">
             ...
             <input id="name" type="text" class="form-control" placeholder="Your full name" required />
            </div>
           </div>
           ...
           <div class="form-group">
            ...
            <div class="input-group input-group-merge">
             ...
             <input id="email" type="email" class="form-control" placeholder="hello@coderthemes.com" />
            </div>
           </div>
           ...
           <div class="form-group mb-4">
            <div class="custom-control custom-checkbox">
             <input id="checkbox-signup" type="checkbox" class="custom-control-input" checked />
