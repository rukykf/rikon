...
<template>
 <Layout>
      ...
      <div v-show="true" class="table-responsive  table-hover mb-0">
       ...
       >
        ...
        <template v-slot:cell(actions)="row">
         <a class="badge badge-primary text-white mx-1" href="#" @click.stop.prevent="showEditRoomModal(row.item)"
          >Edit Room</a
         >
       ...
       <table class="table table-hover">
        ...
        <tbody>
         <tr v-for="(roomType, index) in roomTypes" :key="index">
          ...
          <td>
           <a class="badge badge-primary text-white mx-1" href="#" @click.stop.prevent="showEditRoomTypeModal(roomType)"
            >Edit Room Type</a
           >
           <a class="badge badge-danger text-white mx-1" href="#" @click.stop.prevent="deleteRoomType(roomType)"
            >Delete Room Type</a
           >
          </td>
         </tr>
  ...
  <div>
   ...
   <b-modal @hide="getRoomTypesAndRooms" id="add-room" size="xl" hide-footer header-bg-variant="dark" title="Save Room">
