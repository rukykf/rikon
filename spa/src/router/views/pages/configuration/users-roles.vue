						...
						<div v-show="true" class="table-responsive  table-hover mb-0">
							...
							>
								...
								<template v-slot:cell(actions)="row">
									<a class="badge badge-primary text-white mx-1" href="#" @click.stop.prevent="showEditUserModal(row.item)"
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr v-for="(role, index) in roles" :key="index">
										...
										<td>{{ role.name }}</td>
										<td
											><span v-for="(permission, roleIndex) in role.permissions" :key="roleIndex">{{ permission }}, </span></td
										>
										<td>
											<a class="badge badge-primary text-white mx-1" href="#" @click.stop.prevent="showEditRoleModal(role)"
												>Edit Role</a
											><a class="badge badge-danger text-white mx-1" href="#" @click.stop.prevent="deleteRole(role, $event.target)"
												>Delete Role</a
											></td
										>
									</tr>
