    ...
    methods: {
      ...
      isBookingFormValid() {
        ...
        if (this.bookingForm.phone.length !== 11) {
          this.guestPhoneValidation =
            "The phone number of the guest is required and should be at least 11 characters long"
          return false
        } else {
      ...
      <div class="row">
        <div class="form-group col-12">
          <label for="emailAddress">
            <h6>Email Address: </h6>
            <small v-if="guestEmailAddressValidation !== null" class="text-danger"
              >* {{ guestEmailAddressValidation }}</small
            >
          </label>
        ...
        <div class="form-group col-12">
          <label for="nationality">
            <h6>Nationality: </h6>
            <small v-if="guestNationalityValidation !== null" class="text-danger"
              >* {{ guestNationalityValidation }}</small
            >
          </label>
