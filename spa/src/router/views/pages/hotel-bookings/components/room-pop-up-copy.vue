		...
		<div v-else-if="currentTab === 'book room'">
			<div class="text-center">
				...
				<div v-if="roomDetails.currentBooking !== null" class="row">
					...
					<CollectCashPayment
						:state="buttons.savePaymentBtn.state"
						:disabled="buttons.savePaymentBtn.disabled"
		...
		<div v-else-if="currentTab === 'upcoming reservations'">
			<div class="row">
				...
				<div class="col-12 col-lg-6">
					...
					<StateButton :buttonState="buttons.createReservationBtn" @clicked="createNewReservation"></StateButton>
				</div>
			</div>
		</div>
