    ...
    export default {
        ...
        data() {
            return {
                ...
                saleFields: [
                    ...
                    {key: 'customerInfo', label: 'Customer Info', sortable: true, sortDirection: 'desc'},
        ...
        methods: {
            ...
            getData: async function(){
                let history = await axios.get('http://localhost:3000/creditsales')
            ...
            addTransactionsToMerge(salesRecords){
                this.transactionsForMerging = salesRecords
            },
            clearMergeOperation(){
                this.transactionsForMerging = []
...
<template>
    <Layout>
        <div class="mt-4">
            ...
            <div class="row" v-if="transactionsForMerging.length > 0">
                <div class="col-12 text-right">
                    <button class="btn btn-primary" @click.stop.prevent="clearMergeOperation">Merge {{transactionsForMerging.length}} Records</button>
                ...
                <div class="card-body">
                    ...
                    <div v-else>
                        ...
                        <div class="row mb-3">
                            ...
                            <h3 class="col-12 col-lg-7">Credit Sales from <span class="text-info">March 1st, 2020</span> to <span class="text-info">{{ today }}</span></h3>

                            <div class="col-12 col-lg-5 text-right">
                                <JsonExcel class="btn btn-dark mb-1" :data="sales" :fields="saleExcelFields" worksheet="Rikon Credit Sales" name="rikon-credit-sale-history.xls">
                        ...
                        <div v-show="true" class="table-responsive  table-hover mb-0">
                            <b-table
                                    ...
                                    selectable
                                    select-mode="multi"
                                    @row-selected="addTransactionsToMerge"
                                    ref="creditSalesTable"
                            >

                                <template v-slot:head(totalDue)>
                                    <span>Total Sales</span> <br>
                                    <span class="text-info mt-1">(N150,000)</span>
                                </template>
                                ...
                                <template v-slot:cell(totalDue)="row">
                                    {{ formatSaleItem(row.item.totalDue) }}
                                </template>
                                ...
                                <template v-slot:cell(actions)="row">
                                    <b-button size="sm" variant='dark' @click="showCreditRecordModal(row.item)" class="mr-2">
                                        Show Actions
                                    </b-button>
                                </template>
