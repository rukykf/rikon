    ...
    export default {
        ...
        data() {
            return {
                ...
                orderFields: [
                    ...
                    {key: 'notes', label: 'Cancellation Notes', sortable: true, sortDirection: 'desc'},
        ...
        methods: {
            ...
            getData: async function(){
                let history = await axios.get('http://localhost:3000/orders')
                this.orders = history.data
                this.loading = false
            }
        }
    }
        ...
        <div class="mt-4">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 col-lg-3 mt-1">
                    <StateButton :buttonState="filterBtn" class="px-5 mt-4" @clicked="filterOrders"></StateButton>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div v-else>
                        ...
                        <div class="row mb-3">
                            ...
                            <h3 class="col-12 col-lg-7">Order History from <span class="text-info">March 1st, 2020</span> to <span class="text-info">{{ today }}</span></h3>

                            <div class="col-12 col-lg-5 text-right">
                                <JsonExcel class="btn btn-dark mb-1" :data="orders" :fields="orderExcelFields" worksheet="Rikon Orders" name="rikon-order-history.xls">
                        ...
                        <div v-show="true" class="table-responsive  table-hover mb-0">
                            ...
                            >
                                ...
                                <template v-slot:row-details="row">
                                    <p class="my-3">{{row.item.details}}</p>
                                </template>
