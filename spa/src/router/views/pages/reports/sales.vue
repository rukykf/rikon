                ...
                <div class="card-body">
                    ...
                    <div v-else>
                        ...
                        <div class="row mb-3">
                            ...
                            <h3 class="col-12 col-lg-7">Sales History from <span class="text-info">March 1st, 2020</span> to <span class="text-info">{{ today }}</span></h3>

                            <div class="col-12 col-lg-5 text-right">
                                <JsonExcel class="btn btn-dark mb-1" :data="sales" :fields="saleExcelFields" worksheet="Rikon Sales" name="rikon-sales-history.xls">
