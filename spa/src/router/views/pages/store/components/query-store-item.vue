    ...
    <div>
        ...
        <div class="pt-3">
            <div class="form-group">
                <h6>Expected Quantity: <span class="m-lg-5">{{query.expectedQuantity }}</span></h6>
                ...
                <input type="number" id="queryActualQuantity" name="queryActualQuantity" :disabled="disabled"
                       v-model.number="query.actualQuantity" placeholder=""
                       required
                       class="form-control ">
            </div>
        </div>
