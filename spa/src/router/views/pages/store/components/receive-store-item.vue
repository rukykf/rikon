...
<template>
    ...
    <div>
        ...
        <div class="pt-3">
            <h4>Receive <span class="text-info">({{ newEntryQuantity }})</span> {{ item.unit }} of <span class="text-info">{{ item.name }}</span></h4>
            ...
            <div class="form-group">
                ...
                <input type="text" id="entrySupplier" name="entrySupplier" :disabled="disabled" v-model="newEntry.supplier" placeholder=""
                       class="form-control ">
            </div>
        </div>
