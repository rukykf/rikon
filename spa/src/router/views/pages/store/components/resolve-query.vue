        ...
        <div class="pt-3">
            ...
            <div class="form-group">
                <label for="queryNotes">
                    ...
                    <small v-if="newQueryNotesValidation !== null" class="text-danger">* {{
                        newQueryNotesValidation }}</small>
                </label>

                <textarea id="queryNotes" name="queryNotes" :disabled="disabled"
                       v-model="newQuery.notes" placeholder="e.g Items stolen but recovered from..."
            ...
            <div class="form-group mt-3">
                ...
                <label class="radio-inline">
                    <input type="radio" name="optradio" :disabled="disabled" value="declare missing" v-model="newQuery.actionTaken" checked> Declare Missing
                </label>
                <label class="radio-inline">
                    <input type="radio" name="optradio" :disabled="disabled" value="add items" v-model="newQuery.actionTaken"
                           class="radio-single ml-5 mr-1"> Add {{ newQuery.expectedQuantity - newQuery.actualQuantity }} of {{newQuery.item.name}} to store
                </label>
                <label class="radio-inline">
                    <input type="radio" name="optradio" :disabled="disabled" value="take no action" v-model="newQuery.actionTaken" class="ml-5 mr-1"> Take No Action
                </label>
            </div>
        </div>
