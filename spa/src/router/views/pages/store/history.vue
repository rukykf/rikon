        ...
        data() {
            return {
                ...
                combinedFields: [
                    ...
                    {key: 'itemQuantityBalance', label: 'Quantity Balance After', sortable: true, sortDirection: 'desc'},
                ...
                disbursedFields: [
                    ...
                    {key: 'department', label: 'Department', sortable: true, sortDirection: 'desc'},
                    {key: 'quantity', label: 'Quantity', sortable: true, sortDirection: 'desc'},
                    {key: 'itemQuantityBalance', label: 'Item Quantity After Disbursement', sortable: true, sortDirection: 'desc'},
                    {key: 'date', label: 'Date', sortable: true, sortDirection: 'desc'}
                ],
                receivedFields: [
                    {key: 'SN', label: 'S/N', sortable: false, sortDirection: 'desc'},
                    ...
                    {key: 'supplier', label: 'Supplier', sortable: true, sortDirection: 'desc'},
                    {key: 'quantity', label: 'Quantity', sortable: true, sortDirection: 'desc'},
                    {key: 'itemQuantityBalance', label: 'Item Quantity After Receipt', sortable: true, sortDirection: 'desc'},
                    {key: 'date', label: 'Date', sortable: true, sortDirection: 'desc'}
                ],
                totalRows: 1,
                currentPage: 1,
