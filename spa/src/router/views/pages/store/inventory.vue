            ...
            <div class="card-body">
                ...
                <div v-else class="mt-5">
                    ...
                    <div class="row mb-2">
                        ...
                        <h3 class="col-12 col-lg-7">Stock taken for store on <span class="text-info">{{ today }}</span></h3>

                        <div class="col-12 col-lg-5 text-right">
                            <a href="#" @click.stop.prevent="printItems" class="btn btn-dark mr-3 mb-1">
                                <i class="uil uil-print mr-1"></i> Print
                            </a>
                            <JsonExcel class="btn btn-dark mb-1" :data="items" :fields="excelFields" worksheet="Rikon Store" name="rikon-store-stock.xls">
                        ...
                        <div id="store-items" v-show="true" class="table-responsive  table-hover mb-0">
                            ...
                            >
                                ...
                                <template v-slot:cell(actions)="row">
                                    <a class="btn btn-primary text-white mx-1" href="#" @click.stop.prevent="showEditItemModal(row.item)">Edit</a>
                                    <a class="btn btn-primary text-white mx-1" href="#" @click.stop.prevent="showReceiveItemModal(row.item)">Receive Item</a>
                                    <a class="btn btn-primary text-white mx-1" href="#" @click.stop.prevent="showDisburseItemModal(row.item)">Disburse Item</a>
                                    <a class="btn btn-primary text-white mx-1" href="#" @click.stop.prevent="showQueryItemModal(row.item)">Query Item</a>
                                </template>
                            </b-table>
                        </div>
                    </div>
