      ...
      <div v-show="true" class="table-responsive  table-hover mb-0">
       ...
       >
        ...
        <template v-slot:cell(actions)="row">
         <a class="badge badge-primary text-white mx-1" href="#" @click.stop.prevent="showResolveQueryModal(row.item)"
          >Resolve Query</a
         >
        </template>
       </b-table>
       ...
       <div class="col">
        <div class="dataTables_paginate paging_simple_numbers float-right">
         <ul class="pagination pagination-rounded mb-0">
          <!-- pagination -->
          <b-pagination v-model="currentPage" :total-rows="pendingQueriesRows" :per-page="perPage"></b-pagination>
         </ul>
        </div>
       </div>
      </div>
